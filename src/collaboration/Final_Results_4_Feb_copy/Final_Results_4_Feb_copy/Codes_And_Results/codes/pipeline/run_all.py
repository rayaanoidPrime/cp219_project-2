        ...
        if 'train' in dirnames and 'test' in dirnames:
            ...
            if os.path.exists(train_input_path) and os.path.exists(test_input_path) and \
               (os.path.exists(validation_input_path) if validation else True):
                ...
                # print(f"Found dataset at: {relative_path}")
                ...
                if len(parts) >= 3:
                    ...
                    # print(f"Dataset: {pg['dataset']}, GoID: {pg['goid']}, Attack_Type: {pg['attack_type']}")
                    if validation:
...
def main(algorithm=None,
    ...
    for i, ds in enumerate(datasets):
        try:
            ...
            print(f"Encountered error {e}, skipping dataset : {ds['dataset']} > {ds['goid']} > {ds['attack_type']}")
...
if __name__ == "__main__":
    ...
    root_input_directory = 'c:/Users/Rayaan_Ghosh/Desktop/OSS/cp219_project-2/src/collaboration/Final_Results_4_Feb_copy/Final_Results_4_Feb_copy/Final_Datasets/preprocessed_new'
    # root_input_directory = 'c:/Users/Rayaan_Ghosh/Desktop/OSS/cp219_project-2/src/collaboration/Final_Results_4_Feb_copy/Final_Results_4_Feb_copy/Final_Datasets/sampled_size_powerduck_new'
