...
LABEL_COL       = 'attack'
ALGO_NAME       = 'ocsvm'
OCSVM_DATA_DIR  = 'c:/Users/Rayaan_Ghosh/Desktop/OSS/cp219_project-2/src/collaboration/Final_Results_4_Feb_copy/Final_Results_4_Feb_copy/OCT7Files/unsupervised_codes_Shailja/ocsvm_data'
...
# Default OCSVM hyperparams (kept out of main signature for uniformity)
OCSVM_KERNEL    = 'rbf'
OCSVM_GAMMA     = 'scale'
OCSVM_NU        = 0.05
...
# ==============================================================================
# Core primitives (resource-capturing, unchanged OCSVM logic)
# ==============================================================================
def run_ocsvm(X_train,
              kernel=OCSVM_KERNEL,
              gamma=OCSVM_GAMMA,
              nu=OCSVM_NU):
    ...
    for i in range(1, num_runs + 1):
        ...
        try:
            ...
            with ru.ResourceProfiler() as profiler:
                # Loop the training task N_LOOPS times
                for _ in range(N_LOOPS):
                    y_test_pred, scores = predict(model, X_test)
