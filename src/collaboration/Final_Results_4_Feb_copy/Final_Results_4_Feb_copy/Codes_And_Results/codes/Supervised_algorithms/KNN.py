...
LABEL_COL   = 'attack'
ALGO_NAME   = 'KNN'
IF_DATA_DIR = 'c:/Users/Rayaan_Ghosh/Desktop/OSS/cp219_project-2/src/collaboration/Final_Results_4_Feb_copy/Final_Results_4_Feb_copy/OCT7Files/unsupervised_codes_Shailja/knn_data'
...
def predict(model, X):
    probs = model.predict_proba(X)[:, 1]   # continuous scores for PR-AUC
